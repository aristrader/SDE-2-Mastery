...
- LLD case studies use three stages: a deliberately vague interviewer prompt, a sample candidate
...
- When creating or copying a playground entity-identification/class-diagram worksheet, put the complete
  design-relevant final exercise at its top—goal, requirements, relevant constraints, test scenarios, and
  interview follow-ups—before the candidate's notes and diagrams. Omit repository setup paths and generic
  out-of-scope feature exclusions.
