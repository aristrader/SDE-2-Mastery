...
| 2 | Machine coding / LLD — clarify → classes → interfaces → sequence → edge cases (45–90 min) | 🔴 🎯 | D | 2.5 hrs | [ ] | [x] | [ ] | [ ] | Partial: delivery framework and Parking Lot completed end-to-end; more timed mocks still pending | 📖 [Low-Level Design Interview Framework](/system_design/lld_interview_framework/) · 💻 `system_design/case_studies/parking_lot/exercise/index.md` · 📖 `system_design/case_studies/parking_lot/design/index.md` |
