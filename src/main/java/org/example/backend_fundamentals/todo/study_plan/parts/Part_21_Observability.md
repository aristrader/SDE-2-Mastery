...
|---|-------|------|------|------|------|---|---|-------------|-------|-----------|
| 1 | Logs — structured (JSON), levels, correlation IDs | 🔴 💼 🎯 | MP | 1.5 hrs | [x] | [ ] | [ ] | [ ] | | 📖 `observability/consolidated_observability.md` · 💻 Warm-up: configure Logback / Logstash encoder for JSON output with correlationId via MDC, hit endpoint, inspect log shape (15 min) |
| 2 | Metrics — counters, gauges, histograms, summaries; RED & USE methods | 🔴 💼 🎯 | D | 2 hrs | [x] | [ ] | [ ] | [ ] | | 📖 `observability/consolidated_observability.md` |
| 3 | Traces — spans, context propagation, OpenTelemetry | 🔴 💼 🎯 | D | 2 hrs | [x] | [ ] | [ ] | [ ] | | 📖 `observability/consolidated_observability.md` |
| 4 | Prometheus + Grafana | 🔴 💼 | MP | 1.5 hrs | [x] | [ ] | [ ] | [ ] | | 📖 `observability/consolidated_observability.md` |
| 5 | Datadog (you use it daily) — APM, logs, metrics, monitors | 🔴 💼 | MP | 1.5 hrs | [x] | [ ] | [ ] | [ ] | | 📖 `observability/consolidated_observability.md` · 💻 Warm-up: define a Datadog custom metric via dd-trace-java + verify in Datadog UI (20 min) |
| 6 | Alerts — symptom-based not cause-based; runbooks per alert | 🔴 💼 | MP | 1.5 hrs | [x] | [ ] | [ ] | [ ] | | 📖 `observability/consolidated_observability.md` |
| 7 | On-call hygiene, incident response | 🔴 💼 | MP | 1.5 hrs | [x] | [ ] | [ ] | [ ] | | 📖 `observability/consolidated_observability.md` |
| 8 | Events — discrete vs metric aggregation | 🟠 💼 | M | 45 min | [x] | [ ] | [ ] | [ ] | | |
| 12 | OpenTelemetry — collector, SDKs, instrumentation | 🟠 💼 | D | 2 hrs | [x] | [ ] | [ ] | [ ] | | 📖 `observability/consolidated_observability.md` · 💻 Warm-up: wire OpenTelemetry Java agent into a Spring Boot app + export to OTLP collector (30 min) |
| 13 | Postmortems, blameless culture, 5 whys | 🟠 💼 | MP | 1.5 hrs | [x] | [ ] | [ ] | [ ] | | 📖 `observability/consolidated_observability.md` |
