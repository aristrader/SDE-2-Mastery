...
|---|-------|------|------|------|------|---|---|-------------|-------|-----------|
| 1 | RESTful resource modeling | 🔴 💼 🎯 | MP | 1.5 hrs | [x] | [ ] | [ ] | [ ] | ~1 hr (ChatGPT) — includes HTTP verbs, status codes, over-fetching | 📖 `api_design/api_technologies_summary/index.md` · 📖 `api_design/rest_endpoint_design/index.md` |
