...
| 3 | Optional — orElse / orElseGet / map / flatMap / filter / ifPresent / orElseThrow | 🔴 💼 🎯 | 20 min | [x] | [ ] | [ ] | [ ] | Structured practice created | 📖 `java/coding_fluency/optional/exercise/index.md` · 💻 Rewrite a 3-level null-check chain as Optional; pick the right orElse* variant for each case (eager vs lazy) |
| 4 | Constructor injection — @Component + final fields + @RequiredArgsConstructor | 🔴 💼 | 45 min | [x] | [ ] | [ ] | [ ] | Structured Spring DI practice exists | 📖 `spring/spring_core/dependency_injection/exercise/index.md` |
| 5 | JPA entity + repository — @Entity / @Id / @GeneratedValue / @Column / JpaRepository | 🔴 💼 | 45 min | [x] | [ ] | [ ] | [ ] | Structured JPA repository practice exists | 📖 `spring/spring_data/jpa_repository/exercise/index.md` |
| 6 | Feign client — @FeignClient / request mapping / @PathVariable / error decoder | 🔴 💼 | 45 min | [ ] | [x] | [ ] | [ ] | Partial: structured practice exists; needs one quick personal revision | 📖 `spring/spring_cloud/feign/exercise/index.md` |
| 7 | Global exception handling — @ControllerAdvice / @ExceptionHandler / MethodArgumentNotValidException | 🔴 💼 🎯 | 45 min | [x] | [ ] | [ ] | [ ] | Structured exception-handling practice exists | 📖 `spring/spring_web/exception_handling/exercise/index.md` |
| 8 | Method references — 4 forms (static ref, bound instance ref, unbound instance ref, constructor ref) | 🟠 💼 | 20 min | [x] | [ ] | [ ] | [ ] | Structured practice created | 📖 `java/coding_fluency/method_references/exercise/index.md` · 💻 Replace each lambda in a stream pipeline with the equivalent method reference — one of each form |
| 9 | Lombok — @Value / @Builder / @Data / @Slf4j / @RequiredArgsConstructor | 🟠 💼 | 30 min | [x] | [ ] | [ ] | [ ] | Structured practice created | 📖 `java/coding_fluency/lombok/exercise/index.md` · 💻 Immutable DTO with @Value + @Builder; @Slf4j in a service; compare @Data vs @Value — which allows mutation? |
| 10 | Records as DTOs — compact constructor validation / toBuilder pattern | 🟠 💼 | 20 min | [x] | [ ] | [ ] | [ ] | Structured practice created | 📖 `java/coding_fluency/records/exercise/index.md` · 💻 Define `record TransactionDto(String id, BigDecimal amount)` with compact ctor validation; use as API response body |
| 11 | Immutable collections — List.of / Map.of / Set.of / copyOf — mutation traps | 🟠 💼 | 20 min | [x] | [ ] | [ ] | [ ] | Structured practice created | 📖 `java/coding_fluency/immutable_collections/exercise/index.md` · 💻 Write 3 cases: List.of mutation (UnsupportedOperationException), Map.of null-key (NPE), copyOf proves independence from original |
...
|-------|-----------------------|----------------------|-------------|
| 🔴 MUST only | ~4.58 hrs | ~0.42 wk | |
| 🔴 + 🟠 HIGH | ~14.08 hrs | ~1.28 wk | |
