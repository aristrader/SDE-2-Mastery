...
| 16 | Circuit breakers (closed/open/half-open) | 🔴 💼 🎯 | MP | 1 hr | [x] | [x] | [ ] | [ ] | Theory, states, timeouts vs retries, and cascade failure prevention covered via deep-dive conversation. | 📖 `system_design/concepts/resilience/index.md` · 💻 Warm-up: minimal CircuitBreaker state machine in Java (CLOSED → OPEN → HALF_OPEN); 5 failures opens, probe success closes (45 min) |
...
| 17b | SLO, SLI, SLA definitions and error budgets | 🔴 💼 🎯 | M | 1 hr | [ ] | [x] | [ ] | [ ] | Partial: SLA and availability nines covered from Alex Xu page 38; SLI/SLO definitions and error budgets pending | 📖 `performance/capacity_estimation/index.md` |
...
| 51 | HLD — Google Drive system design | 🟠 🎯 | MP | 2 hrs | [x] | [ ] | [ ] | [ ] | Covered from Alex Xu pages 244-269 plus file-sync deep dive — direct multipart upload, storage completion events, versioned metadata, push-driven cross-device sync, conflicts, regions, and recovery | 📖 `system_design/case_studies/google_drive_system_design/` |
| 52 | HLD — Google Drive / collaborative editing | 🟠 🎯 | MP | 2 hrs | [ ] | [x] | [ ] | [ ] | Partial: Google Drive file storage/sync is covered from Alex Xu pages 244-269; real-time collaborative editing (OT/CRDT, cursors, merge semantics) remains out of scope | 📖 `system_design/case_studies/google_drive_system_design/` |
