...
| 12 | Streams API — intermediate vs terminal, lazy evaluation, parallel streams (and when NOT to use) | 🔴 💼 🎯 | D | 1.5 hrs | [ ] | [x] | [ ] | [ ] | Partial: collectors covered; core intermediate/lazy/parallel stream material still pending | 📖 `java/coding_fluency/streams/index.md` · 💻 `java/coding_fluency/streams/grouping/exercise/index.md` · 💻 `java/coding_fluency/streams/to_map/exercise/index.md` · 💻 `java/coding_fluency/streams/joining/exercise/index.md` · 💻 `java/coding_fluency/streams/advanced_collectors/exercise/index.md` |
