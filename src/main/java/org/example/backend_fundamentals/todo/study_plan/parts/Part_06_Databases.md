...
|---|-------|------|------|------|------|---|----------|-------------|-------|-----------|
| 1 | Normalization (1NF–3NF, BCNF) — and when to denormalize | 🔴 💼 🎯 | M | 1 hr | [x] | [ ] | [ ] | [ ] | ~13 min (ChatGPT) — 1NF–BCNF, functional/partial/transitive deps, dirty-table journey, denormalization trade-offs | 📖 `databases/normalization/index.md` · 📖 `databases/sql_vs_nosql/index.md` (philosophy) |
| 2 | Primary keys, foreign keys, surrogate vs natural | 🔴 💼 🎯 | M | 1 hr 5 min | [ ] | [x] | [ ] | [ ] | Partial: FK / referential integrity / orphaned records / app-vs-DB enforcement covered; surrogate vs natural keys pending | 📖 `databases/sql_vs_nosql/index.md` (FK part) · 💻 Warm-up: basic CRUD on a users table from memory — CREATE TABLE / INSERT / SELECT WHERE / UPDATE / DELETE (20 min) |
| 3 | Indexes — B-tree, composite, covering, partial; INCLUDE columns | 🔴 💼 🎯 | D | 1.5 hrs | [ ] | [x] | [ ] | [ ] | Partial: B+ tree internals (pages, fanout, internal-vs-leaf, splits/rebalance, clustered vs secondary, dense vs sparse, NULLs, AUTO_INCREMENT vs UUID) covered; composite/covering/partial/INCLUDE columns pending. ~18 min (ChatGPT) | 📖 `databases/indexes/index.md` · 📖 Use The Index, Luke! — Markus Winand (free, dip-in reference) |
| 4 | Query planner / EXPLAIN — reading plans, identifying full scans | 🔴 💼 🎯 | D | 1.5 hrs | [ ] | [ ] | [ ] | [ ] |  | 📖 Vlad Mihalcea blog on EXPLAIN ANALYZE · 💻 Warm-up: GROUP BY + COUNT/SUM/AVG/HAVING/ORDER BY from scratch (20 min) |
| 5 | SQL joins — INNER / LEFT / RIGHT semantics and when to use each | 🔴 💼 🎯 | M | 30 min | [ ] | [ ] | [ ] | [ ] |  | 💻 Warm-up: write LEFT / INNER / RIGHT JOIN on orders + customers, observe result-set differences (30 min) |
| 6 | ACID — what each letter actually guarantees | 🔴 💼 🎯 | M | 1 hr | [x] | [ ] | [ ] | [ ] | ~13 min (ChatGPT) — Consistency-means-constraints (vs CAP), A/I/D recap, constraint examples | 📖 `databases/transactions/index.md` · 📖 `databases/sql_vs_nosql/index.md` (transactions part) |
| 7 | Isolation levels — read uncommitted, read committed, repeatable read, serializable | 🔴 💼 🎯 | D | 1.5 hrs | [ ] | [ ] | [ ] | [ ] |  | 📖 *Designing Data-Intensive Applications* ch 7 (Kleppmann — single chapter, ~45 min) |
...
| 12 | SQL vs NoSQL — when each fits: schemaless myth, transactions myth, relational-modeling argument, who-enforces-relationships, DB-level security (defense in depth) | 🔴 💼 🎯 | M | 1 hr | [x] | [ ] | [ ] | [ ] | ~1 hr (ChatGPT) | 📖 `databases/sql_vs_nosql/index.md` |
| 13 | Deadlocks — detection, prevention | 🔴 💼 | MP | 1.5 hrs | [ ] | [ ] | [ ] | [ ] |  |  |
| 14 | Join execution strategies — nested-loop, hash, and merge joins | 🟠 💼 | M | 30 min | [ ] | [ ] | [ ] | [ ] | Query-planner detail; practical SQL join semantics remain red. |  |
| 15 | Document databases — MongoDB/DynamoDB-specific modeling and transaction behavior | 🟠 💼 🎯 | MP | 1.5 hrs | [ ] | [x] | [ ] | [ ] | Partial: MongoDB schema flexibility / validation / transactions / document-modeling limits covered; DynamoDB pending. | 📖 `databases/sql_vs_nosql/index.md` (MongoDB parts) |
| 16 | Redis — data types, persistence, eviction, clustering, pub/sub, streams | 🟠 💼 | D | 1.5 hrs | [ ] | [x] | [ ] | [ ] | Partial: clustering (Redis Cluster, shards, replication, failover) covered; data types, persistence, eviction, pub/sub, streams pending. ~1.5 hr (ChatGPT) | 📖 `system_design/clustering/index.md` · 📖 redis.io "Introduction to Redis" (~30 min) |
| 17 | MySQL — InnoDB internals, gap locks, replication | 🟠 💼 | D | 1.5 hrs | [ ] | [x] | [ ] | [ ] | Partial: replication (primary-replica, async, semi-sync, binlog) covered; InnoDB internals + gap locks pending. ~18 min (ChatGPT) | 📖 `databases/replication/index.md` (replication part) |
| 18 | PostgreSQL — MVCC, vacuum, indexes, extensions | 🟠 💼 | D | 1.5 hrs | [ ] | [ ] | [ ] | [ ] |  |  |
| 19 | DynamoDB — partition keys, GSI/LSI, hot partitions, on-demand vs provisioned | 🟠 💼 | MP | 1.5 hrs | [ ] | [ ] | [ ] | [ ] | Generic partition-key and NoSQL selection principles remain red; this row is vendor-specific depth. |  |
| 20 | Row-level security (RLS) in DBs (e.g. Postgres for multi-tenant) | 🟠 💼 🔐 | D | 1.5 hrs | [ ] | [ ] | [ ] | [ ] |  |  |
| 21 | Transactions — savepoints, distributed, XA, 2PC | 🟠 💼 | MP | 1.5 hrs | [ ] | [x] | [ ] | [ ] | Partial: transaction states/lifecycle + distributed transactions + 2PC (prepare/commit, blocking problem, recovery) + 3PC + Saga/compensating + FLP/consensus covered; savepoints + XA pending. ~45 min (ChatGPT, 3 pastes) | 📖 `databases/distributed_transactions/index.md` · 📖 `databases/transactions/index.md` |
| 22 | Window functions (ROW_NUMBER, RANK, LAG, LEAD) | 🟠 💼 | MP | 1.5 hrs | [ ] | [ ] | [ ] | [ ] |  | 💻 Warm-up: ROW_NUMBER / RANK / LAG over PARTITION BY — find top-N per category, find diff between consecutive rows (20 min) |
| 23 | CTEs (WITH), recursive CTEs | 🟠 💼 | MP | 1 hr 55 min | [ ] | [ ] | [ ] | [ ] |  | 💻 Warm-up: WITH non-recursive + recursive CTE for org-chart hierarchy traversal (25 min) |
| 24 | Materialized views | 🟠 💼 | M | 1 hr | [x] | [ ] | [ ] | [ ] | ~1.5 hr (ChatGPT) | 📖 `databases/views/index.md` |
| 25 | Stored procedures / triggers — and why most teams avoid them now | 🟠 💼 | M | 45 min | [ ] | [ ] | [ ] | [ ] |  |  |
| 26 | Schema migrations safely (Flyway, Liquibase) — backward-compatible changes | 🟠 💼 | MP | 1 hr | [ ] | [ ] | [ ] | [ ] |  |  |
| 27 | Caching layer in front (Redis) | 🟠 💼 🎯 | MP | 1.5 hrs | [x] | [ ] | [ ] | [ ] | Covered from Alex Xu pages 15-16 — cache tier, cache-aside/read-through flow, TTL, consistency, SPOF, overprovisioning, eviction | 📖 `system_design/components/caching/index.md` |
...
| 33 | Elasticsearch — inverted index, mapping, analyzers | 🟠 💼 | MP | 1.5 hrs | [ ] | [ ] | [ ] | [ ] |  |  |
| 34 | Partitioning (range, list, hash) | 🟡 | M | 1 hr | [x] | [ ] | [ ] | [ ] | ~18 min (ChatGPT) — horizontal vs vertical, hash/list/range/composite criteria | 📖 `databases/sharding/index.md` |
| 35 | JSON columns | 🟡 | M | 45 min | [ ] | [ ] | [ ] | [ ] |  |  |
| 36 | Cassandra — partition + clustering keys, tunable consistency | 🟡 | MP | 1.5 hrs | [ ] | [x] | [ ] | [ ] | Partial: tunable consistency, Dynamo/Cassandra-style quorum reads/writes, commit log, memtable, SSTable, Bloom-filter read path covered from Alex Xu pages 95-107; partition + clustering keys pending | 📖 `databases/replication/index.md` (quorum part) · 📖 `databases/key_value_store/index.md` |
| 37 | MongoDB — sharding, secondary indexes, aggregation pipeline | 🟡 | MP | 1.5 hrs | [ ] | [ ] | [ ] | [ ] |  |  |
| 38 | Database federation — federated DBs vs sharding, cross-DB join/transaction cost, modern database-per-service + Saga + BFF | 🟡 💼 🎯 | M | 1 hr | [x] | [ ] | [ ] | [ ] | ~1 hr (ChatGPT) — federation vs sharding contrast, why it faded, BFF as service-layer aggregation | 📖 `databases/federation/index.md` |

## Time summary

| Scope | Hours (zero baseline) | Weeks @ 10–12 hrs/wk | Actual time |
|-------|-----------------------|----------------------|-------------|
| 🔴 MUST only (Sprint priority — 3-month plan) | ~15.58 hrs | ~1.42 wk | |
